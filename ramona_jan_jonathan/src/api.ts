...
export const cloudLogin = async (email: string | undefined = process.env.TAPO_USERNAME || undefined, password: string | undefined = process.env.TAPO_PASSWORD || undefined) => {
    const loginRequest = {
        "method": "login",
        "params": {
...
export const loginDevice = async (email: string | undefined = process.env.TAPO_USERNAME || undefined, password: string | undefined = process.env.TAPO_PASSWORD || undefined, device: TapoDevice) => {
...
export const loginDeviceByIp = async (email: string | undefined = process.env.TAPO_USERNAME || undefined, password: string | undefined = process.env.TAPO_PASSWORD || undefined, deviceIp: string) => {
