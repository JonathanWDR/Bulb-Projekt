...
export const loginDeviceByIp = async (email: string | undefined, password: string| undefined , deviceIp: string| undefined ) => {
    // handshake1
    ...
    const setCookieHeader = headers[0];
...
export class ProtocolUnsupportedError extends Error {
    type: "ProtocolUnsupportedError" = "ProtocolUnsupportedError";
};
